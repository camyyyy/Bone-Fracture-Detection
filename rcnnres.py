...
# 🔧 Fonction pour construire un chemin vers les fichiers du dossier courant
...
def get_model():
    ...
    resnet_path = get_asset_path("weights", "Resnet.pt")
...
def get_vgg_model():
    ...
    vgg_path = get_asset_path("weights", "model_vgg.pt")
    model.load_state_dict(torch.load(vgg_path, map_location='cpu'))

    return model

# 🔎 Prédiction avec filtrage selon le seuil
...
# 📸 Affichage image avec annotation
...
# 🔁 Convertir figure matplotlib vers array
